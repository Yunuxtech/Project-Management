              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="col-lg-2">
                  	...
                  	<p><b>Order Price : </b><span class="btn btn-success"><?php echo"&#8358;:".$fetch_data[0]->qty * $fetch_data[0]->pro_price; ?></span></p>
                  </div>
                  <div class="col-lg-5">
                  	<p><b>Description : </b><?php echo get_value('tbl_product','pro_id',$fetch_data[0]->pro_id,'pro_details'); ?></p>
                  </div>
                   <div class="col-lg-5">
                  	<p><b>Payment Status : </b><span class="btn btn-success"><?php echo $fetch_data[0]->Payment_Status; ?></span></p>
