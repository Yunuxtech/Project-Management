                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <?php }else{ ?>
                        	<td>Not Uploaded</td>
                        <?php } ?>
                        <td ><span class="btn btn-danger"><?php echo $value->order_status; ?></span></td>
                            <td><a href="<?php echo base_url()?>t_order_view/<?php echo $value->order_id;?>" class="btn btn-link btn-danger">View</a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
