      ...
      <div class="content">
        <div class="content">
          <div class="container-fluid">
            <?php
              $datavaluestwo = array('customer_id' => $this->session->userdata('customer_id'),'cutomer_status' => 'SUCCESS');
                            ?>
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <h3 class="card-title"><?php echo get_count('tbl_wishlist',$datavaluestwo,'customer_id'); ?></h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <!-- <i class="material-icons">date_range</i>  -->
                      <a href="#pablo">Total Wishlist Items</a>
                    </div>
                  </div>
                </div>
              </div>
