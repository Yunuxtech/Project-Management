            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">View All Prodcuts</h4>
                </div>
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td><?php echo ++$key; ?></td>
                            <td><?php echo get_value('tbl_category','cat_id',$value->cat_id,'category_name'); ?> / <?php echo get_value('tbl_sub_category','cat_id',$value->sub_cat_id,'sub_cat_name'); ?></td>
                            <td><?php echo $value->pro_name; ?></td>
                            <td><?php echo $value->pro_price; ?></td>
                            <td><?php echo $value->pro_rate; ?></td>
                            <td><img src="<?php echo base_url()?>uploads/<?php echo $value->pro_img; ?>" class="card-avatar1"></td>
                            <td><?php echo $value->status; ?></td>
                            <td class="text-right">
                              <?php if($value->status =='YES'){ $status_val="NO";}else{ $status_val="YES";} ?>
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_product/pro_id/<?php echo $value->pro_id;?>/status/<?php echo $status_val;?>/product_t_view" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status =='YES'){ echo"title='Turn Off Product'"; }else{ echo"title='Turn On Product'";} ?>><i class="material-icons">dvr</i></a>
                            <a href="<?php echo base_url()?>product_t_edit/<?php echo $value->pro_id;?>" class="btn btn-link btn-danger btn-just-icon edit"><i class="material-icons">edit</i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
