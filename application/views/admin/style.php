            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title"><?php if(!empty($edit_fetch_data)){ echo"Edit"; }else{ echo"Add";} ?> Styles
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?php echo base_url()?>style_update" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php }else{ ?>
                  <form method="post" action="<?php echo base_url()?>style_add" id="LoginValidation" enctype="multipart/form-data"> 
                  <?php } ?>
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="style_name" class="bmd-label-floating"> Style Name*</label>
                          <input type="text" class="form-control name_type" required="true" name="style_name" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->style_name){ echo'value="'.$edit_fetch_data[0]->style_name.'"'; } ?> id="style_name">
                          <input type="hidden" class="form-control" required="true" name="style_id" <?php if(!empty($edit_fetch_data) && $edit_fetch_data[0]->style_id){ echo"value='".$edit_fetch_data[0]->style_id."'"; } ?> id="style_id">
                        </div>
                      </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">View All Styles</h4>
                </div>
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo get_value('tbl_sub_category','cat_id',$value->sub_cat_id,'sub_cat_name'); ?></td>
                            <td><?php echo $value->status; ?></td>
                            <td class="text-right">
                              <?php if($value->status =='YES'){ $status_val="NO";}else{ $status_val="YES";} ?>
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_styles/style_id/<?php echo $value->style_id;?>/status/<?php echo $status_val;?>/style" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status =='YES'){ echo"title='Turn Off Style'"; }else{ echo"title='Turn On Style'";} ?>><i class="material-icons">dvr</i></a>
                            <a href="<?php echo base_url()?>style_edit/<?php echo $value->style_id;?>" class="btn btn-link btn-danger btn-just-icon edit"><i class="material-icons">edit</i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
